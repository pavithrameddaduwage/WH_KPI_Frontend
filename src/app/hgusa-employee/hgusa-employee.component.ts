...
@Component({
  selector: 'app-hgusa-employee',
  templateUrl: './hgusa-employee.component.html',
  styleUrls: ['./hgusa-employee.component.css'],
  animations: [
    trigger('fadeInOut', [
      transition(':enter', [
        style({ opacity: 0 }),
...
export class HgusaEmployeeComponent implements OnInit {
  fileTypes = [
    { key: 'employeeDetails', label: 'Horizon Group USA – Employee Details' }
  ];
